...
RUST_SOURCES := main.rs checkpoint/mod.rs checkpoint/handlers/mod.rs checkpoint/handlers/empty.rs checkpoint/handlers/debugcon.rs checkpoint/handlers/phase_test/mod.rs checkpoint/handlers/phase_test/memblock_basic.rs systems.rs systems/kernel.rs systems/kernel/config.rs systems/sbi.rs objects.rs objects/cpu.rs objects/dtb_blob.rs objects/early_console.rs objects/memblock.rs objects/memory_node.rs objects/page_allocator.rs objects/printk.rs objects/ptrace.rs objects/task.rs objects/vm.rs objects/zone.rs phases.rs phases/arch_head.rs phases/asm_macros.rs phases/csr.rs phases/start_kernel.rs
...
$(MEMORY_NODE_TEST): tests/memory_node_host.rs objects/dtb_blob.rs objects/memblock.rs objects/memory_node.rs objects/page_allocator.rs objects/zone.rs | $(BUILD_STAMP)
	$(RUSTC) --edition=2024 --test -o $@ $<
...
ifneq ($(strip $(PHASE_TEST)),)
ifneq ($(filter $(PHASE_TEST),$(PHASE_TESTS)),$(PHASE_TEST))
$(error unknown PHASE_TEST '$(PHASE_TEST)'; expected one of: $(PHASE_TESTS))
endif
endif
...
ifneq ($(strip $(PHASE_TEST)),)
RUSTC_FLAGS += --cfg phase_test_memblock_basic
endif
